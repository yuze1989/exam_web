   ...
   <section class="form_border">
    ...
    >
      ...
      <template slot-scope="scope">
        <el-button @click="relationStudio(scope.row)" type="primary" icon="el-icon-edit" size="small" round>关联画室</el-button>
        <el-button  size="small" @click="statisticsInfo(scope.row)" type="danger" icon="el-icon-delete" round>统计信息</el-button>
      </template>
    </el-table-column>
    </el-table>
    <!--工具条-->
